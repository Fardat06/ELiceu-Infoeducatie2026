...
$csrf      = csrf_token();
$pageTitle = 'Limbi și secții bilingve';
...
<div class="dashboard-container">
  ...
  <main class="dashboard-main">
    ...
    <div class="dashboard-content">
      <div class="dashboard-view active" id="limba">
        ...
        <div class="stats-grid">
          <div class="stat-card">
            <div class="stat-card-header">
              <div class="stat-card-title">Limbi definite</div>
          ...
          <div class="dashboard-table-header">
            <h3 class="dashboard-table-title">
              ...
              <span class="status-badge info"
                    title="Alimentează câmpurile bilingv și limba din tabelele de licee">home_limba</span>
            </h3>
            <div class="table-actions">
              ...
              <button class="btn btn-primary" id="btnAdd">
                ...
                <span class="btn-label">Adaugă limbă</span>
              </button>
            </div>
          </div>
...
<div class="modal-overlay" id="modalForm" hidden>
  <div class="modal-box">
    <form id="frm" novalidate>
      ...
      <input type="hidden" name="id_limba" id="fId" value="">

      <div class="modal-box-header">
        <h3 id="modalTitle">Adaugă limbă</h3>
      ...
      <div class="modal-box-body">
        <div class="form-field">
          ...
          <input type="text" name="description" id="fDesc" maxlength="250" required
                 placeholder="ex: Limba engleză(cu examen)">
          <small class="hint">
            Păstrează formatul existent, inclusiv paranteza:
            <em>Limba X(cu examen)</em> sau <em>Limba X(fără examen)</em>.
            Fără spațiu înaintea parantezei.
          </small>
        </div>
        ...
        <div class="form-field">
          <div class="toast-msg warning" style="box-shadow:none">
            <span>
              Această listă alimentează atât câmpul <strong>bilingv</strong> (secția bilingvă),
              cât și câmpul <strong>limba</strong> (limba de predare) din tabelele de licee.
              O redenumire actualizează automat ambele.
            </span>
          </div>
        </div>
...
<script>
  window.API      = 'plugin/limba_api.php';
  window.ID_FIELD = 'id_limba';
  window.LABEL    = 'limbă';
</script>
